...
public class DLPluginFragmentActivity extends FragmentActivity implements IDLPluginActivity {

    private static final String TAG   = DLPluginFragmentActivity.class.getSimpleName();
